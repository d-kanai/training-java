...
| **OOP原則** | Code Smellの回避 | 高品質な設計 | ✨ |

### 🚫 避けるべきCode Smell

| Code Smell | 説明 | 対策 | 絵文字 |
|------------|------|------|--------|
| **Data Class** | データのみを持つクラス | ビジネスロジックを追加 | 📦 |
| **Feature Envy** | 他クラスのメソッドを多用 | 責務を適切に配置 | 👀 |
| **Tell Don't Ask** | 状態を問い合わせて処理 | オブジェクトに処理を委譲 | 🗣️ |
| **Primitive Obsession** | プリミティブ型の乱用 | Value Objectを活用 | 🔤 |
